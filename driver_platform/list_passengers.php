<div class="container">
    <h1>Passengers on Bus <?php echo htmlspecialchars($busNo); ?> to <?php echo htmlspecialchars($destination); ?> Departing <?php echo htmlspecialchars($busTime); ?></h1>
    <table>
        <tr>
            <th>UniSQ ID:</th>
        ...
        <?php foreach ($passengers_on_trips as $passenger) : ?>
            <tr>
                ...
                <td><?php echo ($passenger['offTime'] !== null) ? date('h:i A', strtotime(htmlspecialchars($passenger['offTime']))) : ''; ?></td>
                <td><?php echo (htmlspecialchars($passenger['finished']) === '0') ? 'OFF' : ''; ?></td>
                <td>
